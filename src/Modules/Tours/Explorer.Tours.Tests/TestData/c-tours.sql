INSERT INTO tours."Tours"(
    "Id", "Name", "Description", "Tags", "Level", "Status", "Price", "AuthorId", "Length", "TransportDurations", "PublishedTime", "ArchivedTime")
VALUES 
...
(-3, 'Tura3', 'Opis trece ture', 'tag1, tag2, tag3', 0, 0,
    jsonb_build_object('Amount', 0, 'Currency', 0), -12, 32.321,
    jsonb_build_array(
        jsonb_build_object('Duration', 50.5, 'Transport', 1),
        jsonb_build_object('Duration', 70.0, 'Transport', 2)
    ), '2023-02-12 08:21:00+02', '2024-03-23 08:32:00+02');

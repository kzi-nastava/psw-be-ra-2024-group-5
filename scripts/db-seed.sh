...
psql -U $DB_USER -h $DB_HOST -p $DB_PORT -d $DB_NAME -f $ROOT_PATH/blogs-seed.sql
psql -U $DB_USER -h $DB_HOST -p $DB_PORT -d $DB_NAME -f $ROOT_PATH/payments-seed.sql
psql -U $DB_USER -h $DB_HOST -p $DB_PORT -d $DB_NAME -f $ROOT_PATH/encounters-seed.sql
